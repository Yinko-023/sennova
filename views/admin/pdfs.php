...
<div class="client-section mb-4">
  <div class="client-header">
    ...
    <div class="client-actions">
      <button class="btn btn-sm btn-outline-primary toggle-client" data-target="client-<?= md5($clienteNombre) ?>">
        <i class="fa-solid fa-chevron-up"></i> Contraer
      </button>
    </div>
  </div>
  
  <div class="client-content" id="client-<?= md5($clienteNombre) ?>">
...
.form-type-form1_solicitud { background: #e3f2fd; color: #1565c0; }
.form-type-form2_evaluacion { background: #f3e5f5; color: #7b1fa2; }
.form-type-form3_cotizacion { background: #e8f5e8; color: #2e7d32; }
.form-type-form4_orden_trabajo { background: #fff3e0; color: #ef6c00; }
.form-type-form5_verificacion_pcb { background: #fce4ec; color: #c2185b; }
.form-type-form6_verificacion_3d { background: #e0f2f1; color: #00695c; }
.form-type-form7_continuidad_pcb { background: #f1f8e9; color: #558b2f; }
.form-type-form8_informe_servicio { background: #e8eaf6; color: #3f51b5; }
.form-type-form9_satisfaccion { background: #fff8e1; color: #ff8f00; }
